...
<nav id="sidebar" class='mx-lt-5 bg-wp2574287'>
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=airline" class="nav-item nav-airline"><span class='icon-field'><i class="fa fa-building"></i></span> Airlines</a>		
